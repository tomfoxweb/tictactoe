...
export const normalAIPlayerTests: AIPlayerTest[] = [
  ...
  {
    title: 'should select vertical cell player X left line',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.X, Cell.O, Cell.EMPTY],
      [Cell.X, Cell.O, Cell.EMPTY],
  ...
  {
    title: 'should select vertical cell player X center line',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.EMPTY, Cell.EMPTY, Cell.EMPTY],
  ...
  {
    title: 'should select vertical cell player X right line',
    figure: PlayerFigure.X,
    gameMap: [
  ...
  {
    title: 'should select last cell diagonal down player X',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.X, Cell.O, Cell.EMPTY],
  ...
  {
    title: 'should select last cell diagonal down player O',
    figure: PlayerFigure.O,
    gameMap: [
      [Cell.EMPTY, Cell.EMPTY, Cell.EMPTY],
      [Cell.EMPTY, Cell.O, Cell.X],
  ...
  {
    title: 'should select last cell horizontal up player X',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.X, Cell.X, Cell.EMPTY],
      [Cell.O, Cell.O, Cell.EMPTY],
  ...
  {
    title: 'should select last cell horizontal up player O',
    figure: PlayerFigure.O,
    gameMap: [
      [Cell.EMPTY, Cell.X, Cell.EMPTY],
      [Cell.X, Cell.X, Cell.EMPTY],
  ...
  {
    title: 'should select last cell vertical left player X',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.X, Cell.EMPTY, Cell.EMPTY],
      [Cell.EMPTY, Cell.O, Cell.EMPTY],
  ...
  {
    title: 'should select last cell vertical left player O',
    figure: PlayerFigure.O,
    gameMap: [
      [Cell.O, Cell.X, Cell.EMPTY],
      [Cell.O, Cell.X, Cell.X],
  ...
  {
    title: 'should select last cell vertical center player X',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.O, Cell.EMPTY, Cell.EMPTY],
      [Cell.O, Cell.X, Cell.EMPTY],
  ...
  {
    title: 'should select last cell vertical center player O',
    figure: PlayerFigure.O,
    gameMap: [
      [Cell.EMPTY, Cell.O, Cell.EMPTY],
      [Cell.X, Cell.EMPTY, Cell.X],
  ...
  {
    title: 'should select last cell vertical right player X',
    figure: PlayerFigure.X,
    gameMap: [
      [Cell.EMPTY, Cell.O, Cell.X],
      [Cell.O, Cell.X, Cell.X],
  ...
  {
    title: 'should select last cell vertical right player O',
    figure: PlayerFigure.O,
    gameMap: [
      [Cell.X, Cell.EMPTY, Cell.EMPTY],
      [Cell.X, Cell.X, Cell.O],
